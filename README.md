...
Este projeto foi desenvolvido durante o curso de desenvolvimento web da Trybe, com o intuito de praticar habilidades de back-end.
...
Para executar o projeto, é necessário ter o `MongoDB` instalado e configurado.

## Executando o projeto localmente

1. Clone o repositório

- `git clone git@github.com:leonardo-pinto/Cookmaster-API.git`.
...
2. Relatório de cobertura dos testes
